...
def build_features(df):
    """Feature cho Bayes: length, category_encoded."""
...
def train_bayes_model():
    """Train GaussianNB để phân loại độ khó từ vựng."""
    df = read_vocabulary()
...
def predict_word_level(word):
    """Dự đoán độ khó; nếu từ không có trong CSV thì trả Unknown."""
